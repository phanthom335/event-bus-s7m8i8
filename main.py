    ...
    Event Bus S7m8i8
    ================
    Developer-ready web service for authenticateing requests with built-in validation.
...
return app
    ...
    def build_parser() -> argparse.ArgumentParser:
        p = argparse.ArgumentParser(prog=APP_NAME, description="Developer-ready web service for authenticateing requests with built-in validation.")
